...
public class ChatbotEventSubscription {
    ...
    // 机器人服务提供地址
    @Value("${" + ChatbotConstants.BOT_PROVIDER + ":" + ChatbotConstants.DEFAULT_BOT_PROVIDER + "}")
    private String botServiecProvider;

    // FAQ最佳回复阀值
    @Value("${" + ChatbotConstants.THRESHOLD_FAQ_BEST_REPLY + ":0.8}")
    private double thresholdFaqBestReply;
    // FAQ建议回复阀值
    @Value("${" + ChatbotConstants.THRESHOLD_FAQ_SUGG_REPLY + ":0.6}")
    private double thresholdFaqSuggReply;
