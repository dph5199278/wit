...
public class AgentUserAspect {
    ...
    @After("execution(* com.cs.wit.persistence.repository.AgentUserRepository.save(..))")
    ...
    @After("execution(* com.cs.wit.persistence.repository.AgentUserRepository.delete(..))")
     ...
     * @throws Throwable
     */
    @Around("@annotation(com.cs.wit.aspect.AgentUserAspect.LinkAgentUser)")
