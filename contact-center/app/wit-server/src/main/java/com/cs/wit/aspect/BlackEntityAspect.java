...
public class BlackEntityAspect {
    ...
    @After("execution(* com.cs.wit.persistence.repository.BlackListRepository.save(..))")
    ...
    @After("execution(* com.cs.wit.persistence.repository.BlackListRepository.delete(..))")
