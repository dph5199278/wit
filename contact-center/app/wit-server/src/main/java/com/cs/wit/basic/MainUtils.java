...
public class MainUtils {
     ...
     * 活动JPA统计结果
     */
    public static com.cs.wit.util.WebIMReport getWebIMReport(List<Object> values) {
        com.cs.wit.util.WebIMReport report = new com.cs.wit.util.WebIMReport();
     ...
     * 活动JPA统计结果
     */
    public static com.cs.wit.util.WebIMReport getWebIMInviteStatus(List<Object> values) {
        com.cs.wit.util.WebIMReport report = new com.cs.wit.util.WebIMReport();
        if (values != null && values.size() > 0) {
            for (Object o : values) {
     ...
     * 活动JPA统计结果
     */
    public static List<com.cs.wit.util.WebIMReport> getWebIMInviteAgg(List<Object> values) {
        List<com.cs.wit.util.WebIMReport> webIMReportList = new ArrayList<>();
        if (values != null && values.size() > 0) {
            for (Object o : values) {
                Object[] value = (Object[]) o;
                com.cs.wit.util.WebIMReport report = new com.cs.wit.util.WebIMReport();
     ...
     * 活动JPA统计结果
     */
    public static List<com.cs.wit.util.WebIMReport> getWebIMDataAgg(List<Object> values) {
        List<com.cs.wit.util.WebIMReport> webIMReportList = new ArrayList<>();
        if (values != null && values.size() > 0) {
            for (Object o : values) {
                Object[] value = (Object[]) o;
     ...
     * 活动JPA统计结果
     */
    public static com.cs.wit.util.WebIMReport getWebIMInviteResult(List<Object> values) {
        com.cs.wit.util.WebIMReport report = new WebIMReport();
        if (values != null && values.size() > 0) {
            for (Object o : values) {
                Object[] value = (Object[]) o;
                if (value.length >= 2) {
