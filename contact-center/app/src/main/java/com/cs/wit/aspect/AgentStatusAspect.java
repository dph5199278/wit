...
public class AgentStatusAspect {
    ...
    @After("execution(* com.cs.wit.persistence.repository.AgentStatusRepository.save(..))")
    ...
    @After("execution(* com.cs.wit.persistence.repository.AgentStatusRepository.delete(..))")
