...
import com.cs.wit.util.dsdata.process.QuickReplyProcess;
...
public class QuickReplyController extends Handler {
    ...
    public ModelAndView index(ModelMap map, HttpServletRequest request, @Valid String typeid) {
        List<com.cs.wit.model.QuickType> quickTypeList = quickTypeRes.findByOrgiAndQuicktype(super.getOrgi(request), MainContext.QuickType.PUB.toString());
    ...
    @Menu(type = "apps", subtype = "kbs")
    public ModelAndView typesave(HttpServletRequest request, @Valid com.cs.wit.model.QuickType quickType) {
    ...
    @Menu(type = "apps", subtype = "kbs")
    public ModelAndView typeupdate(HttpServletRequest request, @Valid com.cs.wit.model.QuickType quickType) {
        com.cs.wit.model.QuickType tempQuickType = quickTypeRes.findByIdAndOrgi(quickType.getId(), super.getOrgi(request));
    ...
    public ModelAndView deletetype(HttpServletRequest request, @Valid String id) {
        if (!StringUtils.isBlank(id)) {
            com.cs.wit.model.QuickType tempQuickType = quickTypeRes.findByIdAndOrgi(id, super.getOrgi(request));
